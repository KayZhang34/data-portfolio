        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-12 shadow-sm border border-gray-200">
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>I am a data analyst based in NYC, and I have 5+ years of experience in consulting and financial services.</p>
              <p>
                I like basketball, lifting, and running. A few of my projects (linked below) reflect these interests in some way.
                If you want to chat about any of these things, feel free to reach out!
              </p>
            </div>
          </div>
