        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          ...
          <div className="bg-white rounded-3xl p-12 shadow-sm border border-gray-200">
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>I am a life-long student.</p>
              <p>
                7 years after graduating from NYU with a degree in Mathematics, I've worked at Curinos and Accenture
                growing as a professional and a human into infinity.
              </p>
              <p>
                I quit my job in late 2024 due to some personal reasons (it felt like the right time),
